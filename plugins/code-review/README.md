...
2. Gathers relevant CRABCODE.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for CRABCODE.md compliance
...
- CRABCODE.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (CRABCODE.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/CRABCODE.md says "Use camelCase for functions")
...
- General quality issues (unless in CRABCODE.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the CrabCode repository. The command is automatically available when using CrabCode.

## Best Practices

### Using `/code-review`
- Maintain clear CRABCODE.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update CRABCODE.md based on recurring review patterns
...
- CRABCODE.md files (optional but recommended for guideline checking)
...
- Make CRABCODE.md more specific about what matters
...
- **Write specific CRABCODE.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update CRABCODE.md based on patterns
...
### Agent architecture
- **2x CRABCODE.md compliance agents**: Redundancy for guideline checks
...
- For CRABCODE.md issues: verifies guideline explicitly mentions it
