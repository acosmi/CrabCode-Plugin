...
Before diving into intuition pumps, CrabCode should gather context by asking the user:
...
Based on the user's responses, CrabCode should guide them through relevant intuition pumps from this list:
...
**Self-Check:** Will this tool application open new biological questions, or just extend existing observations? CrabCode should help the user evaluate this honestly.
...
To ensure the idea has appropriate scope and hasn't been thoroughly explored, CrabCode should ask:
...
After working through intuition pumps, avoiding traps, and reviewing literature, CrabCode should help the user:
...
At the end of this skill, CrabCode should produce a **2-page Problem Ideation Document** containing:
