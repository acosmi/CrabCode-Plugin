...
```
/plugin install code-modernization@crabcode-plugins-official
```

## Recommended Workspace Setup

This plugin ships commands and agents, but modernization projects benefit from a workspace permission layout that enforces the "never touch legacy, freely edit modernized" rule. A starting-point `.crabcode/settings.json` for the project directory you're modernizing:
