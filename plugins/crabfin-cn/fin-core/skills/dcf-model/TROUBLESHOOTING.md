...
**When to read this file:** If engine recalculation (office-suite spreadsheets workflow) reports errors OR valuation results seem unreasonable OR case selector not working properly.
