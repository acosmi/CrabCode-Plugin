...
Apply thematic analysis — see [references/methodology.md](references/methodology.md) for detailed guidance on thematic analysis, affinity mapping, and triangulation techniques.
...
When you need them, read [references/methodology.md](references/methodology.md):
- **Research Synthesis Methodology** — thematic analysis, affinity mapping, triangulation
- **Interview Note Analysis** — extracting insights, cross-interview analysis
- **Survey Data Interpretation** — quantitative and open-ended response analysis
- **Combining Qualitative and Quantitative Insights** — the qual-quant loop, handling disagreement
- **Persona Development from Research** — building evidence-based personas, template, common mistakes
- **Opportunity Sizing** — estimating, scoring, and presenting opportunities
