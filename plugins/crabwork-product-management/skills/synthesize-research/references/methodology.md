...
Methods and frameworks for synthesizing user research. The SKILL.md workflow points here; read the section you need.

## Table of Contents
- [Research Synthesis Methodology](#research-synthesis-methodology) — thematic analysis, affinity mapping, triangulation
- [Interview Note Analysis](#interview-note-analysis) — extracting insights, cross-interview analysis
- [Survey Data Interpretation](#survey-data-interpretation) — quantitative and open-ended analysis
- [Combining Qualitative and Quantitative Insights](#combining-qualitative-and-quantitative-insights)
- [Persona Development from Research](#persona-development-from-research)
