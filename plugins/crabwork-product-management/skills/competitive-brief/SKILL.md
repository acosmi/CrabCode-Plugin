...
#### Feature Comparison
Compare capabilities across key areas relevant to the analysis. See [references/frameworks.md](references/frameworks.md) for rating scales and matrix templates.

#### Positioning Analysis
Analyze how each competitor positions themselves — target customer, category claim, key differentiator, and value proposition. See [references/frameworks.md](references/frameworks.md) for the positioning statement template and message architecture levels.
...
- **Competitive Landscape Mapping** — direct/indirect/adjacent competitors, landscape axes, monitoring
- **Feature Comparison Matrices** — rating scales, matrix template, comparison tips
- **Positioning Analysis Frameworks** — positioning statement, message architecture, positioning gaps
- **Win/Loss Analysis Methodology** — data sources, interview questions, common patterns
- **Market Trend Identification** — trend sources, analysis framework, signal vs noise, response options
