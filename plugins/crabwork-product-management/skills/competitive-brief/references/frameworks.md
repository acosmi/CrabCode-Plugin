# Competitive Brief Reference

Frameworks for competitive landscape mapping, feature comparison, positioning, win/loss, and trend analysis. The SKILL.md workflow points here; read the section you need.

## Table of Contents
- [Competitive Landscape Mapping](#competitive-landscape-mapping) — competitive set, landscape map, monitoring
- [Feature Comparison Matrices](#feature-comparison-matrices) — rating scales, matrix template, tips
- [Positioning Analysis Frameworks](#positioning-analysis-frameworks) — positioning statement, message architecture, gaps
- [Win/Loss Analysis Methodology](#winloss-analysis-methodology) — interview questions, analysis, patterns
- [Market Trend Identification](#market-trend-identification) — sources, analysis framework, signal vs noise, responses
