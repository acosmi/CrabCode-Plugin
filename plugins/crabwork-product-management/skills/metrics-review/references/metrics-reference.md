...
Deep reference for metric definitions, goal-setting, review cadences, and dashboard design. Read the section you need while running a metrics review; the SKILL.md workflow points here.

## Table of Contents
- [Product Metrics Hierarchy](#product-metrics-hierarchy) — North Star, L1, L2
- [Common Product Metrics](#common-product-metrics) — DAU/WAU/MAU, retention, conversion, activation
- [Goal Setting Frameworks](#goal-setting-frameworks) — OKRs, target setting
- [Metric Review Cadences](#metric-review-cadences) — weekly, monthly, quarterly
- [Dashboard Design Principles](#dashboard-design-principles) — layout, anti-patterns, alerting
