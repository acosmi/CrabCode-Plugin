...
面向产品经理的 CrabCode 插件，当前可通过直接粘贴内容、描述问题和上传文件完成产品管理工作流；外部项目管理与协作连接均暂停。
...
- **干系人汇报** — 按受众(高管、研发、客户)生成状态汇报；当前上下文必须由用户直接提供。
...
CrabCode: 你想综合哪些研究?请粘贴访谈记录或上传文件；当前不能从外部来源拉取。
你: [粘贴 8 份访谈记录]
...
当前只能手动提供上下文；下列项目管理与协作连接是历史/未来目录。
