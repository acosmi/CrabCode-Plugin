# CRABCODE.md Update Guidelines

## Core Principle

Only add information that will genuinely help future CrabCode sessions. The context window is precious - every line must earn its place.
...
- [ ] Would a new CrabCode session find this helpful?
