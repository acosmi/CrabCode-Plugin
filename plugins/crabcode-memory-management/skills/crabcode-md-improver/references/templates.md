...
Describe the project structure so CrabCode understands where things live.
...
List important files that CrabCode should know about.
...
4. **Be useful**: Would this help a new CrabCode session understand the project?
