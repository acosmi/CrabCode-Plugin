...
A comprehensive plugin for creating and verifying CrabCode Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new CrabCode Agent SDK application.
