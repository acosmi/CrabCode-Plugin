...
**The Agent tool cannot enforce tool restriction.** Agents get the full tool
...
and omits them will produce agents that grind Python for 30 iterations and
...
| ------ | ------- | ---------------------- | -------------- | ---------------------- |
| <model-id>  | 8       | 3                      | 2 revise fails | skip                   |
| <model-id> | 4       | 5                      | 3 revise fails | yes                    |
| <model-id>   | 3       | 5 + full pattern sweep | 4 revise fails | 2 drafts, pick cleaner |
