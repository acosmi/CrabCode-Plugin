...
Full structure and type-specific best practices for each article type — how-to, troubleshooting, FAQ, and known issue — live in [references/article-templates.md](references/article-templates.md). Once you've chosen the type that fits the source material, pull its template from there and follow it.
