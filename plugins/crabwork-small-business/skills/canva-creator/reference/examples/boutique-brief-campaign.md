...
```
CrabCode: I found 3 square-post templates in your Canva library:
...
CrabCode: Got it. I'll use "Boutique Square - Cream" for all feed posts.
...
Email rows skip Canva entirely. CrabCode writes the email subject, preheader,
