...
MCP tool) do not expire. Native CrabCode carousels render the autofill
...
7. **Present the row's candidates.** Let the native CrabCode carousel
...
**Email content** — CrabCode writes the entire email; no Canva:
