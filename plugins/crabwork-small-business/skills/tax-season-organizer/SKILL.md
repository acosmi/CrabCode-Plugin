...
version: 0.3.0
description: >
  为小微企业主整理报税季材料 —— 定位为交给「代账会计 / 税务师」的交接包,而非税务意见,
  也绝不代客申报纳税或向税务机关报送。两种模式:(1)季度申报数据整理 —— 依据业主导出的
  当季经营数据(CSV/Excel,或从用友好会计 / 金蝶精斗云粘贴),梳理增值税(小规模纳税人当季
  销售额是否超季度免征线、征收率;一般纳税人销项减进项)、附加税费(城建税 / 教育费附加 /
  地方教育附加)与企业所得税季度预缴(小型微利优惠)或个体工商户 / 个人独资经营所得预缴,
  产出交接包供代账会计核对申报;(2)年度汇算清缴数据整理 —— 依据全年经营数据与进销项发票,
  结合支付宝商家平台 / 微信支付商户平台的收付流水,核对全年收入、成本费用(税前扣除凭证须为
  发票)与可享的小微优惠,产出企业所得税或经营所得汇算的交接包。
