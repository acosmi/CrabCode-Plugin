...
then say "let's close the month." CrabCode walks you through each step of the checklist,
pausing for your input at each gate before moving forward.

If a connector is missing, CrabCode falls back to asking for a CSV export — it won't
