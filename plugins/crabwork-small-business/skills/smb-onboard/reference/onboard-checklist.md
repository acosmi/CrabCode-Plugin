...
4. **Tools already in use.** "Which tools do you already use day-to-day? Things like 用友好会计, 金蝶精斗云, 支付宝, 微信支付, 钉钉, 飞书, 腾讯文档, HubSpot…"
...
| Customer follow-up | HubSpot | dingtalk or feishu | `crm-maintenance` (read-only demo) |
