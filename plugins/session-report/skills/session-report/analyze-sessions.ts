// Ported from upstream analyze-sessions.mjs to TypeScript by window-D
 ...
 * analyze-sessions.js
 *
 * Scans ~/.crabcode/projects/**.jsonl transcript files and reports token usage,
...
const ROOT = flag('--dir', path.join(os.homedir(), '.crabcode', 'projects'))
...
function printText({ overall, perProject, perSubagent, perSkill }) {
  ...
  line()
  line(`CrabCode session analysis — ${ROOT}`)
