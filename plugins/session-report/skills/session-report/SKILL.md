...
Produce a self-contained HTML report of CrabCode usage and save it to the current working directory.
...
- `top_prompts` already includes agent tokens and rolls task-notification continuations into the originating prompt.
