...
Historical Discord messaging-bridge design. A future reviewed runtime would
...
package has no executable entry and does not start the wrapper; future runtime
work must pass a separate security and release review.
