...
The user adjusts controls, explores visually, then copies the generated prompt back into CrabCode.
...
Add this plugin to your CrabCode configuration to enable the playground skill.
