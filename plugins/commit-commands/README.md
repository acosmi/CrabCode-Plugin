...
- Includes CrabCode attribution in commit message
...
This plugin is included in the CrabCode repository. The commands are automatically available when using CrabCode.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let CrabCode analyze your changes and match your repo's commit style
...
- CrabCode will analyze the full branch history for the PR description
...
- **Let CrabCode draft messages**: The commit message analysis learns from your repo's style
