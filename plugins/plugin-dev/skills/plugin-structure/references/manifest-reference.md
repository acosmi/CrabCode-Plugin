...
The manifest MUST be in the `.crabcode-plugin/` directory at the plugin root. CrabCode will not recognize plugins without this file in the correct location.
...
- Plugin identification in CrabCode
...
CrabCode validates the manifest on plugin load:
