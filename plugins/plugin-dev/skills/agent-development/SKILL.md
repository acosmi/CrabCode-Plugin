---
name: 插件智能体开发
short-description: 设计插件智能体的结构、提示词、触发条件与工具权限
description: This skill should be used when the user asks to "create an agent", "add an agent", "write a agent", "agent frontmatter", "when to use description", "agent examples", "agent tools", "agent colors", "autonomous agent", or needs guidance on agent structure, system prompts, triggering conditions, or agent development best practices for CrabCode plugins.
version: 0.1.0
---

# Agent Development for CrabCode plugins
...
Defines when CrabCode should trigger this agent. **This is the most critical field** — it is loaded into context whenever the agent is registered, so the harness can decide when to dispatch.
...
Use this prompt pattern (extracted from CrabCode):
...
3. Check CrabCode loads the agent
...
- **`references/agent-creation-system-prompt.md`** - The exact prompt from CrabCode
