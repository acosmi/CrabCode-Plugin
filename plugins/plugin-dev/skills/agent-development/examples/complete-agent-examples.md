...
3. Check adherence to project best practices and coding standards from CRABCODE.md
...
5. **Best Practices**:
   - Follow project-specific standards from CRABCODE.md
...
- Missing context (no CRABCODE.md): Apply general best practices
