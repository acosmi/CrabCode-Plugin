...
Use this template to generate agents using CrabCode with the agent creation system prompt.
...
Send this to CrabCode (with the agent-creation-system-prompt loaded):
...
### Step 3: CrabCode Returns JSON

CrabCode will return:
...
Tell CrabCode when the agent should activate:
...
- **Comprehensive**: CrabCode includes edge cases and quality checks
