...
Tests individual hook scripts with sample input before deploying to CrabCode.
...
**Features:**
- Sets up proper environment variables (CRABCODE_PROJECT_DIR, CRABCODE_PLUGIN_ROOT)
...
- Path in hooks.json is correct (use `${CRABCODE_PLUGIN_ROOT}`)
