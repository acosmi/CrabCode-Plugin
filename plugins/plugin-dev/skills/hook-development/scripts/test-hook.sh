...
# Set up environment
export CRABCODE_PROJECT_DIR="${CRABCODE_PROJECT_DIR:-/tmp/test-project}"
export CRABCODE_PLUGIN_ROOT="${CRABCODE_PLUGIN_ROOT:-$(pwd)}"
export CRABCODE_ENV_FILE="${CRABCODE_ENV_FILE:-/tmp/test-env-$$}"

if [ "$VERBOSE" = true ]; then
  echo "Environment:"
  echo "  CRABCODE_PROJECT_DIR=$CRABCODE_PROJECT_DIR"
  echo "  CRABCODE_PLUGIN_ROOT=$CRABCODE_PLUGIN_ROOT"
  echo "  CRABCODE_ENV_FILE=$CRABCODE_ENV_FILE"
  echo ""
fi
...
if [ -f "$CRABCODE_ENV_FILE" ]; then
  echo ""
  echo "Environment file created:"
  cat "$CRABCODE_ENV_FILE"
  rm -f "$CRABCODE_ENV_FILE"
fi
