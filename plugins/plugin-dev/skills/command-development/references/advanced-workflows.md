...
Deployment state saved to `.crabcode/deployment-state.local.md`:
...
Reading deployment state from `.crabcode/deployment-state.local.md`...
...
```markdown
.crabcode/plugin-name-workflow.local.md:
...
Reading workflow state from .crabcode/plugin-name-workflow.local.md...

Current stage: @.crabcode/plugin-name-workflow.local.md
...
State file: @.crabcode/plugin-name-workflow.local.md
...
Creating: .crabcode/feature-complete.flag
...
!`validate.sh`
echo "checkpoint:validation" >> .crabcode/deployment-checkpoints.log

## Checkpoint 2: Build
!`build.sh`
echo "checkpoint:build" >> .crabcode/deployment-checkpoints.log

## Checkpoint 3: Deploy
!`deploy.sh`
echo "checkpoint:deploy" >> .crabcode/deployment-checkpoints.log
...
Written to .crabcode/deployment-state.local.md
...
Reading state: @.crabcode/deployment-state.local.md
...
rm .crabcode/deployment-state.local.md
