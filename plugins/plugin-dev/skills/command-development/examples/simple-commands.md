...
**Important:** All examples below are written as instructions FOR CrabCode (agent consumption), not messages TO users. Commands tell CrabCode what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.crabcode/commands/review.md`
...
**File:** `.crabcode/commands/security-review.md`
...
**File:** `.crabcode/commands/test-file.md`
...
**File:** `.crabcode/commands/document.md`
...
**File:** `.crabcode/commands/git-status.md`
...
**File:** `.crabcode/commands/deploy.md`
...
**File:** `.crabcode/commands/compare-files.md`
...
**File:** `.crabcode/commands/quick-fix.md`
...
**File:** `.crabcode/commands/research.md`
...
**File:** `.crabcode/commands/explain.md`
