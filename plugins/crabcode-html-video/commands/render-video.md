...
1. 激活 `crabcode-html-video:video-storyboard`：与用户确认主题/事实/风格/画幅 → 产出 ContentGraph → `validateGraph`
2. 激活 `crabcode-html-video:video-frames`：按 topo 顺序为每个节点写独立 HTML → `lintFrame` / 可选 `previewFrame`
