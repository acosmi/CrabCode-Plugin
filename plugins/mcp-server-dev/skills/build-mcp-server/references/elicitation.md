...
| Host | Status |
|---|---|
| CrabCode | ✅ since v2.1.76 (both `form` and `url` modes) |
| CrabCode Desktop | Unconfirmed — likely not yet or very recent |
| crabcode.ai | Unknown |
...
server.registerTool("delete_all", {
  ...
  // Fallback: return text asking CrabCode to relay the question
