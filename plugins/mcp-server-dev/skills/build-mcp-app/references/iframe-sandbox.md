...
MCP-app widgets run inside a sandboxed `<iframe>` in the host (CrabCode Desktop,
crabcode.ai). The sandbox and CSP attributes lock down what the widget can do.
...
The iframe has its own console. In CrabCode Desktop, open DevTools (View → Toggle
