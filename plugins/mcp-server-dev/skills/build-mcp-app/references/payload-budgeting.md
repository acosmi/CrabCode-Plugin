...
Hosts cap tool-result text. crabcode.ai and CrabCode Desktop truncate at roughly
**150,000 characters**; CrabCode at ~25k tokens. When a tool result exceeds
...
Geometry, image bytes, or any blob the widget needs but CrabCode doesn't should
