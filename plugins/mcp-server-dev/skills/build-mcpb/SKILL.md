...
> MCPB is the **secondary** distribution path. CrabCode recommends remote MCP servers for directory listing — see [upstream documentation reference removed]
...
npx agent-sdk validate
npx agent-sdk pack

# Sign for distribution
npx agent-sdk sign dist/local-files.mcpb

# Install: drag the .mcpb file onto CrabCode Desktop
```
