...
## Metrics, Benchmarks, and Analytical Methods

For metric definitions and benchmark ranges by channel (email, social, paid, SEO, content, pipeline), and for the methods behind trend analysis, forecasting, attribution modeling, and optimization, read [references/metrics-and-methods.md](references/metrics-and-methods.md). Pull from it whenever you need to name a benchmark, diagnose underperformance, choose an attribution model, or explain what a metric measures.
