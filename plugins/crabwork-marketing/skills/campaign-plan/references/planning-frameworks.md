# Campaign Plan — Planning Frameworks

Reference material for the `campaign-plan` skill. Consult the relevant section when
selecting channels, building the content calendar, allocating budget, or choosing
success metrics for a campaign.

## Contents
- [Campaign Framework: Objective, Audience, Message, Channel, Measure](#campaign-framework-objective-audience-message-channel-measure)
- [Channel Selection Guide](#channel-selection-guide) — owned, earned, and paid channels with effort and metrics
- [Content Calendar Creation](#content-calendar-creation) — planning process, cadence, and production timelines
- [Budget Allocation Approaches](#budget-allocation-approaches) — methods and channel-allocation frameworks
- [Success Metrics by Campaign Type](#success-metrics-by-campaign-type) — KPIs for each campaign objective
