...
For the deeper frameworks behind these sections — the Objective/Audience/Message/Channel/Measure model, the channel selection guide (owned, earned, paid with effort and metrics), content calendar planning and production timelines, budget allocation methods, and success metrics by campaign type — read [references/planning-frameworks.md](references/planning-frameworks.md). Consult it when choosing channels, building the calendar, allocating budget, or setting KPIs.
