...
Simply ask questions that match an agent's focus area, and CrabCode will automatically trigger the appropriate agent:
...
CrabCode may proactively use these agents based on context:
...
- User agents: `~/.crabcode/agents/`
- Project agents: `.crabcode/agents/` in crabcode-cli-internal
